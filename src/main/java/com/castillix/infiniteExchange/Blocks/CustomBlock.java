package com.castillix.infiniteExchange.Blocks;
...
public class CustomBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof CustomBlockEntity) {
                ItemScatterer.spawn(world, pos, (CustomBlockEntity)blockEntity);
                // update comparators
